...
plt.savefig("./add_same_position_step_discount_negative_reward_function_eval_%s.jpg" % argv[1])
np.save("add_same_position_step_discount_negative_%s_eval.array" % argv[1], total_rew)
