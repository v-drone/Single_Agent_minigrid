...
$configPath = "C:\Users\mingzhi\Documents\UAV\Single_Agent_minigrid\airsim_uav_configs\$port.json"
...
$unityExecutablePath = "C:\Users\mingzhi\Documents\UAV\airsimdrone$unityPort\AirSimAssets.exe"
...
if (Test-Path -Path $unityExecutablePath -PathType Leaf)
{
    try
    {
        ...
        if ($process -and !$process.HasExited)
        {
            ...
            $pythonScriptPath = ".\airsim_client\airsim_drone_runner.py"
