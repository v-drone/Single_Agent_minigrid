...
class CustomBlockCNN(TorchModelV2, nn.Module):
    ...
    def __init__(self, obs_space, action_space: Space, num_outputs, model_config, name):
        ...
        self.resnet = models.ResNet(models.resnet.BasicBlock, [2, 2, 2, 2], num_classes=num_outputs)
        self.resnet.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=1, padding=3)
        self._features = None
    ...
    def forward(self, input_dict, state, seq_lens):
        ...
        self._features = self.resnet(self._features)
