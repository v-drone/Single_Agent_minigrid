...
class AirSimConnectionError(AirSimError):
    ...
    def __init__(self, message="Failed to connect to AirSim server"):
...
class AirSimResponseError(AirSimError):
    ...
    def __init__(self, message="Invalid response from AirSim server"):
        self.message = message
        super().__init__(self.message)
...
class AirSimRestartFailed(AirSimError):
    ...
    def __init__(self, message="Failed to restart AirSim server"):
        self.message = message
        super().__init__(self.message)
